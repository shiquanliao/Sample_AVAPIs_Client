//
// Created by CC000033 on 2018/10/25.
//

#ifndef JINGZIAPP_OPENSL_ES_UTIL_H
#define JINGZIAPP_OPENSL_ES_UTIL_H
...
/**
 * Convert type(int) to type(SLuint32)
 * @param channels
 * @return  信道数
 */
...
/**
 * Convert type(SLresult) to type(string)
 * @param result
 * @return
 */
...
#endif //JINGZIAPP_OPENSL_ES_UTIL_H
